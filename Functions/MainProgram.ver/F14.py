...
def help(role):
    ...
    if role == 'user':
        ...
        print("2. list_game_toko - Untuk melihat game-game yang ada di toko")
        print("3. buy_game - Untuk membeli game yang terdapat di toko")
        ...
        print("===============help================")
        print("1. login - Untuk masuk ke dalam aplikasi dengan memasukkan username dan password")
        print("2. help - memberikan panduan penggunaan sistem")
